...
{currentDeckHtml}                </div>
                        ...
                        <div id="deckHealthPanel" class="deck-health-panel">
                            ...
                            <div class="deck-priority-grid" id="deckPriorityGrid">
                                <div class="deck-priority-card upgrade-priority">
                                    <div class="deck-priority-head">
                                        <span>Upgrade Priority</span>
                                        <span id="upgradePriorityScore" class="deck-priority-score">-</span>
                                    </div>
                                    <div id="upgradePriorityName" class="deck-priority-name">Add cards to evaluate.</div>
                                    <div id="upgradePriorityReason" class="deck-priority-reason">Upgrade recommendation will appear here.</div>
                                    <details class="deck-priority-details">
                                        <summary>Why?</summary>
                                        <ul id="upgradePriorityWhy" class="deck-priority-why">
                                            <li>No deck data yet.</li>
                                        </ul>
                                    </details>
                                </div>
                                <div class="deck-priority-card removal-priority">
                                    <div class="deck-priority-head">
                                        <span>Removal Priority</span>
                                        <span id="removalPriorityScore" class="deck-priority-score">-</span>
                                    </div>
                                    <div id="removalPriorityName" class="deck-priority-name">Add cards to evaluate.</div>
                                    <div id="removalPriorityReason" class="deck-priority-reason">Removal recommendation will appear here.</div>
                                    <details class="deck-priority-details">
                                        <summary>Why?</summary>
                                        <ul id="removalPriorityWhy" class="deck-priority-why">
                                            <li>No deck data yet.</li>
                                        </ul>
                                    </details>
                                </div>
                            </div>
                            <div class="deck-strategy-card" id="deckStrategyCard">
                                <div class="deck-strategy-head">
                                    <span>Fight Strategy</span>
                                    <span id="deckStrategyTag" class="deck-strategy-tag">Adaptive</span>
                                </div>
                                <div id="deckStrategySummary" class="deck-strategy-summary">Add cards to get a play pattern recommendation.</div>
                                <details class="deck-strategy-details">
                                    <summary>Plan</summary>
                                    <ul id="deckStrategyPlan" class="deck-strategy-plan">
                                        <li>No deck data yet.</li>
                                    </ul>
                                </details>
                            </div>
